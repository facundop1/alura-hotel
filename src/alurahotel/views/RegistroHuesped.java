...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("/alurahotel/imagenes/lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/alurahotel/imagenes/icon-reservas.png")));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (RegistroHuesped.txtNombre.getText() != null && RegistroHuesped.txtApellido.getText() != null
						...
						&& RegistroHuesped.txtNacionalidad.getSelectedItem() != null
						&& RegistroHuesped.txtTelefono.getText() != null) {
					GuardarHuespedes();
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/alurahotel/imagenes/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/alurahotel/imagenes/Ha-100px.png")));
	...
	private void GuardarHuespedes() {
		try {
			...
			String fecha_nacimientoS = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
			Date fecha_nacimiento = java.sql.Date.valueOf(fecha_nacimientoS);
			String nacionalidad = txtNacionalidad.getSelectedItem().toString();
			String telefono = txtTelefono.getText();
			Integer reserva_id = Integer.valueOf(txtNreserva.getText());

			Huespedes huespedes = new Huespedes(nombre,apellido,fecha_nacimiento,nacionalidad,telefono,reserva_id);
			this.huespedesController.guardar(huespedes);

			JOptionPane.showMessageDialog(this, "Su numero de reserva es: " + reserva_id);
		} catch (Exception e){
			JOptionPane.showConfirmDialog(contentPane, "Error: " + e.getMessage(),
