...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/alurahotel/imagenes/aH-40px.png")));
		...
		txtFechaE.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/alurahotel/imagenes/icon-reservas.png")));
		...
		txtFechaS.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/alurahotel/imagenes/icon-reservas.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/alurahotel/imagenes/Ha-100px.png")));
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/alurahotel/imagenes/reservas-img-3.png")));
	...
	public void GuardarReservas() {
		try {
			...
			Reservas reservas = new Reservas(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS),
